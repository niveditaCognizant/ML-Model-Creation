...
namespace Modelbuilder
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\555397\Downloads\yelp_labelled.tsv.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=8,NumberOfLeaves=11,FeatureFraction=0.85183465F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}));
